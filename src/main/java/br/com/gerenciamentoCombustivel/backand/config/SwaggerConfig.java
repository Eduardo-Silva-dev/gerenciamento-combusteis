package br.com.gerenciamentoCombustivel.backand.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("br.com.gerenciamentoCombustivel.backand.controller"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do Nutri-Life",
				"Esta API é utilizada no sistema Nutri-Life", 
				"Versão 1.0",
				null,
				new Contact(null,null,null),
				"Não Permidito para copia", 
				null, 
